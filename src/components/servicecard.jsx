...
const ServiceCard = ({ icon, title, description }) => {
    return (
        <div className='group p-8 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#0b1120] shadow-sm hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 flex flex-col items-start text-left'>
